...
export const projectsData: ProjectCaseStudy[] = [
  {
    ...
    "summary": "Comprehensive municipal wastewater treatment plant engineering consolidating high-precision geomatic setting out, deep bored cast-in-situ piling foundations, mass earthwork dewatering, heavy water-retaining reinforced concrete (RCC) tank casting, waterstop joint sealing, and full-spectrum material quality testing across Sallaghari, Kodku, and Dhobighat packages.",
    "facts": [
      {
        "label": "PROJECT TYPE",
    ...
    "phases": [
      {
        ...
        "summary": "Establishment of permanent geodetic survey pillars, closed-traverse coordinate transfer, and high-accuracy horizontal/vertical setting out for all structural units, boundary lines, and hydraulic pipelines across Sallaghari, Kodku, and Dhobighat sites.",
        "keyTasks": [
      ...
      },
      {
        ...
        "summary": "Execution of bored cast-in-situ reinforced concrete piles to transfer heavy hydraulic tank and superstructure loads through soft alluvial strata to competent bearing layers.",
        "keyTasks": [
      ...
      },
      {
        ...
        "summary": "Systematic mass earthwork excavation, high groundwater table management, and casting of level Plain Cement Concrete (PCC) mud-mats for foundation rafts.",
        "keyTasks": [
      ...
      },
      {
        ...
        "summary": "Fabrication and casting of heavy water-retaining reinforced concrete structural elements with stringent water-tightness tolerances, heavy rebar mats, and specialized expansion/construction joints.",
        "keyTasks": [
      ...
      },
      {
        ...
        "summary": "Daily quality compliance, fresh and hardened concrete testing, aggregate grading verification, and workforce safety coordination for 40–50 site laborers.",
        "keyTasks": [
    ...
    "drawings": [
      {
        ...
        "description": "Detailed 2D engineering drawing and process flow schematic showing primary settling tanks, aeration basins, secondary clarifiers, sludge handling units, and inter-tank pipeline profiles at Sallaghari.",
      ...
      },
      {
        ...
        "description": "Overall wastewater treatment plant layout showing unit arrangements, influent distribution chambers, hydraulic flow lines, and site road network.",
