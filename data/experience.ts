...
export const experienceData: ExperienceItem[] = [
  {
    ...
    "description": "Leading on-site engineering execution, setting out, and quality control on the Construction of Wastewater Treatment Plant at Sallaghari, Kodku and Dhobighat — covering heavy reinforced concrete tanks, deep bored piling, and underground pipeline installations.",
    "achievements": [
  ...
  },
  {
    ...
    "description": "Developed 2D architectural drawings for residential structures using AutoCAD, assisted in foundation layout planning, and observed surveying and site inspection practices.",
    "achievements": [
